                    ...
                    <div class="row align-items-center g-4">
                        <div class="col-lg-6">
                            ...
                            <p class="hero-text">
                                ...
                                одежде и онлайн-курсах. Карточки ниже загружаются с backend API через XMLHttpRequest.
                            </p>
                ...
                <div class="row g-3 mb-5">
                    <div class="col-md-4">
                        <div class="mini-info-card">
                            <div class="info-number">XHR</div>
                            <div>Данные карточек приходят с backend по адресу <b>/cashbacks</b>.</div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mini-info-card">
