# ЛР №6. Знакомство с promise и fetch, cборка клиентской части
...
## Тема
История живописи. Услуги — картины художников. Заявки — заявки на экспертизу для определения авторства картины.

## Сайт для вдохновения
для вдохновения: https://rusmuseumvrm.ru/collections/painting/index.php
